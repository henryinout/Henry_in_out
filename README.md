# Henry Zhang - Academic & Project Portfolio

**Applicant for Class of 2030**
*Intended Major: Mathematics*

This repository serves as a technical supplement to my Common App application. It contains source code, mathematical proofs, and design documentation that substantiate my research and extracurricular projects.
...
> *"Mathematics does not need to be forced upon the world... it serves as the quiet, invisible scaffolding."*

I have hidden a small, logic-based "Easter Egg" within the `Welcome` directory of this repository. It is a simple tribute to the joy of discovery.

* **Hint:** The key relates to the year non-Euclidean geometry was independently discovered (as mentioned in my essay).
